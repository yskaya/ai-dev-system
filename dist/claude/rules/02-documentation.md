...
Slash-command artifacts under `docs/ai/` (e.g. `001-BRIEF.md`) are required implementation output — write them even when other documentation would stay lightweight.
